...
<input type="text" class="form" name="email" id="email" placeholder="Введите email"><br>
...
*Если вы еще не зарегистрированы, то самое время сделать это! Нажмите на <a href="register2.php">зарегистрироваться</a> 
     </form>
         <?php
